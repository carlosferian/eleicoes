...
class OptionsTest(unittest.TestCase):
    def test_parse_command_line(self):
        ...
        options.parse_command_line(["eleicoes.py", "--port=443"])
    ...
    def test_parse_callbacks(self):
        ...
        options.parse_command_line(["eleicoes.py"], final=False)
        self.assertFalse(self.called)

        # final parse does
        options.parse_command_line(["eleicoes.py"])
    ...
    def test_help(self):
        ...
        try:
            ...
            with self.assertRaises(SystemExit):
                options.parse_command_line(["eleicoes.py", "--help"])
    ...
    def test_subcommand(self):
        ...
        rest = base_options.parse_command_line(
            ["eleicoes.py", "--verbose", "subcommand", "--foo=bar"]
        )
    ...
    def test_mock_patch(self):
        ...
        options.parse_command_line(["eleicoes.py", "--foo=2"])
        self.assertEqual(options.foo, 2)
    ...
    def test_multiple_string(self):
        ...
        options.parse_command_line(["eleicoes.py", "--foo=a,b,c"])
        self.assertEqual(options.foo, ["a", "b", "c"])

    def test_multiple_int(self):
        options = OptionParser()
        options.define("foo", type=int, multiple=True)
        options.parse_command_line(["eleicoes.py", "--foo=1,3,5:7"])
    ...
    def test_dash_underscore_cli(self):
        ...
        for defined_name in ["foo-bar", "foo_bar"]:
            for flag in ["--foo-bar=a", "--foo_bar=a"]:
                ...
                options.parse_command_line(["eleicoes.py", flag])
